# RAG-Pipeline
1. Chat with Website Using RAG Pipeline: Implementing a Retrieval-Augmented Generation (RAG) pipeline that allows users to interact with structured and unstructured data extracted from websites. The system will crawl, scrape, and store website content, convert it into embeddings, and store it in a vector database.

2. Chat with PDF Using RAG Pipeline: 
Implementing a Retrieval-Augmented Generation (RAG) pipeline that allows users to
